...
function submitForm() {
    ...
    if (annee && quartier) {
        ...
        // Utiliser fetch pour récupérer les données avec la nouvelle requête
        fetch('/donnees', {
            method: 'POST',
            headers: {
        ...
        .then(data => {
            ...
            .then(data => {
                ...
                const average = data[0].average_victim_count;
                // Utiliser l'option 'fr-FR' pour la France, vous pouvez ajuster la locale selon vos besoins.
